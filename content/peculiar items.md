...
- _Truth of the Prey -_ {Exs}: For the rest of the Scene you gain the Temporary Trait _On the Hunt_ with "At start of your Main Step, choose two characters at random that took Damage since your last turn. Attack one of them. Whenever you bring a character to 0 WP, Attack them. Additionally, whenever you Kill a character you gain a Hunger Charge"
- _Iron in the Wind -_ {Scene}: You Learn the location of Target character you have met as long as they do not have full WP, Preparation WP don't count. ATDD you may also Learn a Secret regarding their body, such as race, possible modifications, and such. You must have at least 2 Hunger Charges to use to Ability and the Target cannot have _Metal of the Damned_
- _Cycle the Nutrients -_ While this Item is Active, whenever you take Damage store that Damage in a Pool. Whenever you Hit remove X Damage from the Pool and Heal X Damage, where X is the Damage you Dealt in the Attack. This Ability is Active only if you have 5 or more Hunger Charges
- _Truth of the Predator -_ When you use _Truth of the Prey_ for the first time each Scene, you howl and all Target characters in the Scene gain 1 Fear of You Persistent Token. Choose a Symbol and Exalt it. This Ability is Active only if you have 10 or more Hunger Charges
- _Metal of the Damned -_ When you gain 5 Hunger Charges with this Item the Director choose an Appropriate narrative element, such as silver, fire or similar depending on the context of the Story. In the presence of such element you cannot gain WP

**All That Was Given (Binding)** (7)
_A bronze sword, forged with savage iron bearing a simple inscription "what more could you take?"_
...
**Solar Script** (3)
_When I joined the order I was told to read and memorize one line and one line only. Collectively we carry the entirety of that cursed book_
